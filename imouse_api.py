...
class HttpApi:
    ...
    def __init__(self, host='127.0.0.1'):
        self._api_url = f"http://{host}:9912/api"
    ...
    def shortcut_photo_list(self, deviceid='', num=5, date='', outtime=30000):
        """获取手机照片列表"""
        ret = self._post(self._data_creation.shortcut(deviceid, 1, [], json.dumps({"date": date, "num": num}), outtime, self._get_msgid(True)))
    ...
    def shortcut_del_photo(self, deviceid='', files=None, devlist=None, outtime=30000):
        """删除照片 - parameter 是文件名数组的JSON"""
        return self._post(self._data_creation.shortcut(deviceid, 3, devlist or [], json.dumps(files or []), outtime, self._get_msgid(True)))
    ...
    def shortcut_del_file(self, deviceid='', files=None, devlist=None, outtime=30000):
        """删除文件 - parameter 是文件名数组的JSON"""
        return self._post(self._data_creation.shortcut(deviceid, 6, devlist or [], json.dumps(files or []), outtime, self._get_msgid(True)))

    def shortcut_up_photo(self, deviceid='', files=None, name='Recents', devlist=None, outtime=60000):
        """上传照片 - files: 本地文件路径列表 如 ["d:\\abc1.png","d:\\abc2.png"]"""
        return self._post(self._data_creation.shortcut(deviceid, 7, devlist or [], {"name": name, "list": files or []}, outtime, self._get_msgid(True)))

    def shortcut_up_file(self, deviceid='', files=None, path='', devlist=None, outtime=60000):
        """上传文件 - files: 本地文件路径列表"""
        return self._post(self._data_creation.shortcut(deviceid, 8, devlist or [], {"path": path, "list": files or []}, outtime, self._get_msgid(True)))

    def shortcut_send_clipboard(self, deviceid='', text='', devlist=None, outtime=30000):
        """发送文字到手机剪切板"""
        hex_text = self._utf8_to_hex(text)
        return self._post(self._data_creation.shortcut(deviceid, 10, devlist or [], json.dumps({"text": hex_text}), outtime, self._get_msgid(True)))

    def shortcut_get_clipboard(self, deviceid='', devlist=None, outtime=30000):
        """获取手机的剪切板内容"""
        ret = self._post(self._data_creation.shortcut(deviceid, 11, devlist or [], '{}', outtime, self._get_msgid(True)))
        if ret and 'retdata' in ret:
            rd = ret['retdata']
            if isinstance(rd, dict) and 'text' in rd:
                try:
                    rd['text'] = self._hex_to_utf8(rd['text'])
                except:
                    pass
            return rd
        return ret
    ...
    def shortcut_open_url(self, deviceid='', url='', devlist=None, outtime=30000):
        """打开url"""
        return self._post(self._data_creation.shortcut(deviceid, 13, devlist or [], json.dumps({"url": url}), outtime, self._get_msgid(True)))

    def shortcut_set_lightness(self, deviceid='', level=1.0, devlist=None, outtime=30000):
        """设置屏幕亮度"""
        return self._post(self._data_creation.shortcut(deviceid, 14, devlist or [], json.dumps({"level": level}), outtime, self._get_msgid(True)))

    def shortcut_switch_settings(self, deviceid='', id=16, devlist=None, outtime=30000):
        """快捷功能"""
        return self._post(self._data_creation.shortcut(deviceid, id, devlist or [], '{}', outtime, self._get_msgid(True)))
...
class WsApi(HttpApi):
    ...
    def _init_ws_command(self):
        self._ws_command = WebSocketApp(
            "ws://{}:9911/clinet".format(self._host),
    ...
    def _post(self, post_data):
        ...
        while time.time() - start < self._outtime:
            ...
            time.sleep(0.01)
        return {"fun": fun, "status": -1, "message": "接口调用超时"}
...
class Data_Creation:
    ...
    def set_dev(self, deviceid='', msgid=0, data=None):
        result = {"fun": "set_dev", "data": {"deviceid": deviceid}, "msgid": msgid}
        if data:
            result["data"].update(data)
        return result

    def del_dev(self, deviceid='', msgid=0):
        return {"fun": "del_dev", "data": {"deviceid": deviceid}, "msgid": msgid}

    def set_group(self, gid=0, name='', msgid=0):
        return {"fun": "set_group", "data": {"gid": gid, "name": name}, "msgid": msgid}

    def del_group(self, gid=0, msgid=0):
        return {"fun": "del_group", "data": {"gid": gid}, "msgid": msgid}

    def get_device_list(self, msgid=0):
        return {"fun": "get_device_list", "data": {}, "msgid": msgid}

    def get_group_list(self, msgid=0):
        return {"fun": "get_group_list", "data": {}, "msgid": msgid}

    def get_usb_list(self, msgid=0):
        return {"fun": "get_usb_list", "data": {}, "msgid": msgid}

    def get_devicemodel_list(self, msgid=0):
        return {"fun": "get_devicemodel_list", "data": {}, "msgid": msgid}

    def get_device_screenshot(self, deviceid='', gzip=False, binary=False, msgid=0, isJpg=True, original=False):
        return {"fun": "get_device_screenshot", "data": {
            "deviceid": deviceid, "gzip": gzip, "binary": binary,
            "isjpg": isJpg, "original": original
        }, "msgid": msgid}

    def loop_device_screenshot(self, deviceid='', time=100, stop=False, msgid=0, isJpg=True):
        return {"fun": "loop_device_screenshot", "data": {
            "deviceid": deviceid, "time": time, "stop": stop, "isjpg": isJpg
        }, "msgid": msgid}

    def click(self, deviceid='', x=0, y=0, button='left', time=0, msgid=0):
        return {"fun": "click", "data": {
            "deviceid": deviceid, "button": button, "x": x, "y": y, "time": time
        }, "msgid": msgid}

    def swipe(self, deviceid='', direction='left', button='left', length=0,
              sx=0, sy=0, ex=0, ey=0, afor=0, msgid=0):
        return {"fun": "swipe", "data": {
            "deviceid": deviceid, "direction": direction, "button": button,
            "length": length, "sx": sx, "sy": sy, "ex": ex, "ey": ey, "for": afor
        }, "msgid": msgid}

    def mouse_up(self, deviceid='', button='left', msgid=0):
        return {"fun": "mouse_up", "data": {"deviceid": deviceid, "button": button}, "msgid": msgid}

    def mouse_down(self, deviceid='', button='left', msgid=0):
        return {"fun": "mouse_down", "data": {"deviceid": deviceid, "button": button}, "msgid": msgid}

    def mouse_move(self, deviceid='', x=0, y=0, msgid=0):
        return {"fun": "mouse_move", "data": {"deviceid": deviceid, "x": x, "y": y}, "msgid": msgid}

    def mouse_wheel(self, deviceid='', direction='up', length=0, number=1, msgid=0):
        return {"fun": "mouse_wheel", "data": {
            "deviceid": deviceid, "direction": direction, "length": length, "number": number
        }, "msgid": msgid}

    def mouse_reset_pos(self, deviceid='', msgid=0):
        return {"fun": "mouse_reset_pos", "data": {"deviceid": deviceid}, "msgid": msgid}

    def send_key(self, deviceid='', key='', fn_key=None, msgid=0):
        result = {"fun": "send_key", "data": {"deviceid": deviceid, "key": key}, "msgid": msgid}
        if fn_key:
            result["data"]["fn_key"] = fn_key
        return result

    def restart(self, msgid=0):
        return {"fun": "restart", "data": {}, "msgid": msgid}
    ...
    def mouse_collection_open(self, deviceid='', msgid=0):
        return {"fun": "mouse_collection_open", "data": {"deviceid": deviceid}, "msgid": msgid}

    def mouse_collection_close(self, deviceid='', msgid=0):
        return {"fun": "mouse_collection_close", "data": {"deviceid": deviceid}, "msgid": msgid}

    def mouse_collection_cfg(self, deviceid='', msgid=0):
        return {"fun": "mouse_collection_cfg", "data": {"deviceid": deviceid}, "msgid": msgid}

    def save_dev_location(self, deviceid='', describe='', msgid=0):
        return {"fun": "save_dev_location", "data": {"deviceid": deviceid, "describe": describe}, "msgid": msgid}
    ...
    def send_text(self, deviceid='', key='', fn_key=None, msgid=0):
        return {"fun": "send_text", "data": {"deviceid": deviceid, "key": key, "fn_key": fn_key}, "msgid": msgid}

    def find_image(self, deviceid='', img=None, rect=None, original=False, similarity=0.8, msgid=0):
        result = {"fun": "find_image", "data": {
            "deviceid": deviceid, "img": img, "original": original, "similarity": similarity
        }, "msgid": msgid}
        if rect:
    ...
    def find_imageEx(self, deviceid='', img_list=None, rect=None, original=False,
        ...
        result = {"fun": "find_image_ex", "data": {
            "deviceid": deviceid, "img_list": img_list or [], "original": original,
    ...
    def ocr(self, fun='ocr', deviceid='', rect=None, original=False, msgid=0):
        result = {"fun": fun, "data": {"deviceid": deviceid, "original": original}, "msgid": msgid}
        if rect:
            result["data"]["rect"] = rect
        return result
    ...
    def find_multi_color(self, deviceid='', rect=None, first_color='', offset_color='',
        ...
        return {"fun": "find_multi_color", "data": {
            "deviceid": deviceid, "rect": rect, "first_color": first_color,
            "offset_color": offset_color, "similarity": similarity, "dir": dir
        }, "msgid": msgid}

    def auto_connect_screen(self, deviceid='', force=False, msgid=0):
        return {"fun": "auto_connect_screen", "data": {"deviceid": deviceid, "force": force}, "msgid": msgid}

    def save_autoscreen_point(self, deviceid='', msgid=0):
        return {"fun": "save_autoscreen_point", "data": {"deviceid": deviceid}, "msgid": msgid}

    def restart_usb(self, deviceid='', msgid=0):
        return {"fun": "restart_usb", "data": {"deviceid": deviceid}, "msgid": msgid}

    def set_usb_autoairplay(self, deviceid='', autoairplay=False, msgid=0):
        return {"fun": "set_usb_autoairplay", "data": {"deviceid": deviceid, "autoairplay": autoairplay}, "msgid": msgid}

    def get_usb_autoairplay(self, deviceid='', msgid=0):
        return {"fun": "get_usb_autoairplay", "data": {"deviceid": deviceid}, "msgid": msgid}

    def set_airplay_mode(self, deviceid='', airplay_mode=0, msgid=0):
        return {"fun": "set_airplay_mode", "data": {"deviceid": deviceid, "airplay_mode": airplay_mode}, "msgid": msgid}

    def get_airplay_mode(self, deviceid='', msgid=0):
        return {"fun": "get_airplay_mode", "data": {"deviceid": deviceid}, "msgid": msgid}

    def save_restart_point(self, deviceid='', msgid=0):
        return {"fun": "save_restart_point", "data": {"deviceid": deviceid}, "msgid": msgid}

    def restart_device(self, deviceid='', msgid=0):
        return {"fun": "restart_device", "data": {"deviceid": deviceid}, "msgid": msgid}
    ...
    def auto_connect_screen_all(self, msgid=0):
        return {"fun": "auto_connect_screen_all", "data": {}, "msgid": msgid}

    def discon_airplay(self, deviceid='', msgid=0):
        return {"fun": "discon_airplay", "data": {"deviceid": deviceid}, "msgid": msgid}

    def shortcut(self, deviceid='', id=0, devlist=None, parameter='', outtime=30000, msgid=0):
        return {"fun": "shortcut", "data": {
            "deviceid": deviceid, "id": id, "devlist": devlist or [],
